...
return [
    ...
    'state_change' => 'click to change the state',
    'state_stop_hint' => 'The agent is working on it: choosing a state stops it.',
    'state_question_hint' => 'The agent is waiting for your answers (see above); choosing a state cancels the question.',
