...
return [
    ...
    'plan' => [
        ...
        'hint' => 'The AI splits the goal into ordered tasks chained one after the other: start the first one (🟢) and each next one opens when the previous is done.',
        ...
        'built' => 'Plan created: :count chained tasks. Start the first one (🟢) to begin.',
