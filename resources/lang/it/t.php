...
return [
    ...
    'questions_title' => '❓ Domande di :agent',
    ...
    'settings_agent_title' => '🤖 Come lavora :agent',
    ...
    'settings_fields' => [
        ...
        'task_mode' => ['Modalità di lavoro sui task', 'Se l\'agente lavora i task 🟢 uno alla volta in ordine, oppure più task in parallelo.'],
        ...
        'terse_agent' => ['Modalità stringata', 'l\'agente scrive quasi nulla in chat (niente spiegazioni né riepiloghi), accorpa i comandi, legge solo il necessario e non ripete i controlli. La chat diventa poco leggibile per un umano; la board (commento 🤖, notifiche) continua a funzionare come sempre.'],
        ...
        'toast_console_changes' => ['Toast per i cambi da console', 'Avviso in pagina quando l\'agente cambia lo stato di un elemento (🔧 ✔ ❓).'],
    ...
    'settings_options' => [
        ...
        'task_mode_warn' => '⚠️ Con il multitasking l\'agente può prendere in carico più task 🟢 insieme: più veloce, ma può creare conflitti (commit sovrapposti, modifiche agli stessi file). Usalo solo per task indipendenti.',
