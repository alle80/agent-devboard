...
return [
    ...
    'skills_hint' => 'Skill che l\'agente attiverà lavorando a questo task (catalogo da devboard:skills-import).',
    ...
    'notif' => [
        ...
        'diag_local_title' => 'Agent Devboard — prova locale',
    ...
    'settings_fields' => [
        ...
        'mode' => ['Modalità della board', 'Server = serve il login, ogni utente ha le sue liste (accesso limitabile, vedi config). Local = NESSUNA autenticazione, un solo insieme di liste globali: solo per una board sulla propria macchina. Vuoto = come nel config (DEVBOARD_MODE).'],
    ...
    'settings_options' => [
        ...
        'mode_config' => 'Come nel config (DEVBOARD_MODE)', 'mode_server' => 'Server — login richiesto, liste per utente', 'mode_local' => 'Local — senza login, liste globali',
